...
})({"8ZH7k":[function(require,module,exports) {
...
const CardRe = ()=>{
    ...
    }, (0, _redomEsJs.el)("span", {
        className: "card__number"
    }, "xxxx xxxx xxxx xxxx"), (0, _redomEsJs.el)("div", {
        className: "card__personal"
    }, (0, _redomEsJs.el)("span", {
        className: "card__name"
    }, "John Doe"), (0, _redomEsJs.el)("span", {
        className: "card__date"
    }, "04/24")));
    const formInput = (nameBlock, nameText)=>(0, _redomEsJs.el)("div", {
            className: `form__input-wrap form__input-wrap_${nameBlock}`
        }, (0, _redomEsJs.el)("label", {
            className: `form__label form__${nameBlock}-label`
        }, `${nameText}`), (0, _redomEsJs.el)("input", {
            className: `input input__${nameBlock}`,
            type: "text",
            name: `${nameBlock}`,
            required: true
        }));
    const formCard = (0, _redomEsJs.el)("form", {
        className: "form"
    }, formInput("holder", "Card Holder"), formInput("number", "cardNumber"), formInput("date", "Card Expiry"), formInput("cvv", "CVV"), (0, _redomEsJs.el)("button", {
...
},{}]},["8ZH7k","2OpUZ"], "2OpUZ", "parcelRequire470e")
